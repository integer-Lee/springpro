    		...
    		<table class="table table-bordered">
    			...
    			<tr>
    				<td colspan="2" align="center">
    					<button type="submit" class="btn btn-primary btn-sum">수정</button>
    					<button type="reset" class="btn btn-warning btn-sum">취소</button>
    					<button type="button" class="btn btn-info btn-sum" onclick="location.href='../boardList.do'">목록</button>
    				</td>
    			</tr>
    		</table>
    	</form>
